...
CREATE TABLE festival_ReservationHasEvent(
	...
	,CONSTRAINT ReservationHasEvent_Event_FK FOREIGN KEY (Id_Date) REFERENCES Event(Id_Date)
	,CONSTRAINT ReservationHasEvent_Reservation0_FK FOREIGN KEY (ID_RESERVATION) REFERENCES Reservation(ID_RESERVATION)
)ENGINE=InnoDB;
...
CREATE TABLE festival_ReservationHasNight(
	...
	,CONSTRAINT ReservationHasNight_Night_FK FOREIGN KEY (Id_Date) REFERENCES Night(Id_Date)
	,CONSTRAINT ReservationHasNight_Reservation0_FK FOREIGN KEY (ID_RESERVATION) REFERENCES Reservation(ID_RESERVATION)
)ENGINE=InnoDB;
